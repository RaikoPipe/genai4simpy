...
> Execution environment for an event-based simulation. The passing of
> time is simulated by stepping from event to event.
>
...
>
> The \"\_\_get\_\_()\" descriptor is basically identical to
> \"function.\_\_get\_\_()\" and binds the first argument of the \"cls\"
> to the descriptor instance.
>
> static bind_early(instance: object) -\> None
>
> > Bind all \"BoundClass\" attributes of the *instance\'s* class to the
> > instance itself to increase performance.
