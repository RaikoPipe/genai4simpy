...
asynchronous processes. For one-to-many a simple BroadCastPipe class is
constructed from Store.
...
:   When a consumer process does not always wait on a generating process
    ...
    Finally, using pipes can simplify how processes are interconnected
    to each other in a simulation model.
...
::: literalinclude
code/process_communication.py
:::

The simulation\'s output:

::: literalinclude
code/process_communication.out
:::
