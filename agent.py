...
def create_run_agent(dataset_name: str, run_name: str, data_path: str, model_name:str) -> dict:
    ...
    model = init_chat_model(
        ...
        temperature=0.2,
        #reasoning="high",
        base_url="https://dashscope-intl.aliyuncs.com/compatible-mode/v1",#"http://localhost:11434",
        #num_ctx=128000,
        api_key="sk-ws-H.YMLDLI.9PBs.MEQCIGKHQ3ymY5oEvpprjzNEOnp3zWOP6-g6p6ElmCu6z1qmAiBeZ89-uiqvY6gC-twKPtF7dFo5aIk6tQ-dbFkPjJYHLA"
        #**kwargs
    )
